    ...
    <div class="info-controles">
      ...
      <div class="info-botones">
        ...
        <button
          ...
          class="info-boton-wa info-boton-chat"
          :title="`Consultar por ${producto?.name}`"
        >
          <svg class="info-boton-icono" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
.info-boton-wa {
  ...
  justify-content: center;
  padding: 0.75rem;
  background: rgba(163, 141, 112, 0.10);
  border: 1.5px solid rgba(163, 141, 112, 0.25);
  color: var(--cp-sage);
  border-radius: var(--r-sm);
  cursor: pointer;
  transition:
...
.info-boton-wa:hover {
  ...
  color: var(--cp-white);
  transform: translateY(-1px);
  box-shadow: 0 4px 20px rgba(163, 141, 112, 0.30);
}
...
.info-boton-wa {
  ...
  border: none;
  cursor: pointer;
  box-shadow: 0 2px 12px rgba(163, 141, 112, 0.22);
  transition:
    background var(--transition),
    transform 0.18s ease,
    box-shadow var(--transition);
...
.info-boton-wa:hover {
  ...
  transform: translateY(-1px);
  box-shadow: 0 4px 20px rgba(163, 141, 112, 0.38);
}
