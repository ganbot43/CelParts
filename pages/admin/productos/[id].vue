        ...
        <form @submit.prevent="saveProduct" class="publish-form">
          ...
          <div class="form-group">
            ...
            <div class="upload-area">
              ...
              <p class="upload-text"><strong>Arrastre aquí su fotografía</strong> o <span class="upload-link">selecciónela de su computadora</span></p>
...
onMounted(() => {
  if (isEditing.value) {
    // In a real app, fetch the product data here to populate the form
    // For now, just set some mock data if editing
    form.value = {
