    ...
    <div class="login-wrapper">
      ...
      <div class="login-card" :class="{ 'card-shake': shaking }">
        ...
        <div class="form-body">
          ...
          <div class="field-group">
            <UFormField label="Nombre o Empresa" name="name">
              <div class="input-wrapper" :class="{ focused: focusedField === 'name' }">
                <UInput v-model="form.name" type="text" placeholder="Ej. Juan Pérez" class="smart-input pl-4"
                  :ui="inputUI" @focus="focusedField = 'name'" @blur="focusedField = ''" @keyup.enter="register" />
              </div>
            </UFormField>

            <UFormField label="Correo electrónico" name="email">
              <div class="input-wrapper" :class="{ focused: focusedField === 'email' }">
                <UInput v-model="form.email" type="email" placeholder="ejemplo@correo.com" class="smart-input pl-4"
                  :ui="inputUI" @focus="focusedField = 'email'" @blur="focusedField = ''" @keyup.enter="register" />
              </div>
            </UFormField>

            <UFormField label="Teléfono / Celular (Opcional)" name="phone">
              <div class="input-wrapper" :class="{ focused: focusedField === 'phone' }">
                <UInput v-model="form.phone" type="tel" placeholder="+51 999 999 999" class="smart-input pl-4"
                  :ui="inputUI" @focus="focusedField = 'phone'" @blur="focusedField = ''" @keyup.enter="register" />
              </div>
            </UFormField>
            ...
            <UFormField label="Contraseña" name="password">
              <div class="input-wrapper" :class="{ focused: focusedField === 'password' }">
                <UInput v-model="form.password" :type="showPassword ? 'text' : 'password'" placeholder="••••••••"
                  class="smart-input pl-4" :ui="inputUI" @focus="focusedField = 'password'" @blur="focusedField = ''"
                ...
                <button class="toggle-password" type="button" @click="showPassword = !showPassword" tabindex="-1">
                  <svg v-if="!showPassword" viewBox="0 0 20 20" fill="none" width="16" height="16">
                    <path d="M2.5 10s2.917-5 7.5-5 7.5 5 7.5 5-2.917 5-7.5 5-7.5-5-7.5-5z" stroke="currentColor"
                      stroke-width="1.5" />
          ...
          <button class="submit-btn" :class="{ loading }" :disabled="loading" @click="register">
...
.login-card {
  ...
  box-shadow: 0 0 0 1px rgba(255, 255, 255, 0.04) inset, 0 24px 64px rgba(0, 0, 0, 0.5), 0 0 80px rgba(99, 102, 241, 0.05);
  overflow: hidden;
